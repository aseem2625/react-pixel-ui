...
function (_React$PureComponent) {
  ...
  _proto.render = function render() {
    var _this$props = this.props,
        ...
        uiClass = _this$props.uiClass,
        className = _this$props.className,
        restProps = objectWithoutPropertiesLoose(_this$props, ["isLink", "iconBefore", "iconAfter", "children", "onClick", "uiClass", "className"]);

    return React.createElement("button", _extends_1({}, restProps, {
      onClick: restProps.disabled ? undefined : onClick,
      className: classList('Btn', className && prefixToClasses('Btn--', className), isLink && 'Btn--link', uiClass)
...
function (_React$PureComponent) {
  ...
  _proto.render = function render() {
    var _this$props = this.props,
        ...
        restProps = objectWithoutPropertiesLoose(_this$props, ["pendingText", "onClick", "children", "className", "disabled", "isPending"]);
    ...
    if (children instanceof Array) {
      children.forEach(function (c) {
        if (c && typeof c === 'function') {
          withSpinner = true;
          btnContent.push(React.createElement(React.Fragment, {
            key: "Spinner"
          }, c(isPending)));
        } else {
          if (!isPending || pendingText) btnContent.push(React.createElement("span", {
            key: "text",
            className: "Btn-text"
      ...
      if (!isPending || pendingText) btnContent = React.createElement("span", {
        key: "text",
        className: "Btn-text"
    ...
    return React.createElement(Button, _extends_1({}, restProps, {
      className: classList('AsyncBtn', className, isPending && 'AsyncBtn--isPending', withSpinner && 'AsyncBtn--withSpinner'),
...
var RipplePointer = function RipplePointer(_ref) {
  var className = _ref.className,
      uiClass = _ref.uiClass,
      onClick = _ref.onClick,
      restProps = objectWithoutPropertiesLoose(_ref, ["className", "uiClass", "onClick"]);

  return React.createElement("div", _extends_1({}, restProps, {
    className: classList('RipplePointer', prefixToClasses('RipplePointer--', className), uiClass, onClick && 'RipplePointer--clickable')
...
var HelpText = function HelpText(_ref) {
  ...
  return React.createElement("div", {
    className: classList('HelpText', uiClass)
  }, children);
};
...
/*#__PURE__*/
function (_React$PureComponent) {
  inheritsLoose(SmartTipContent, _React$PureComponent);

  function SmartTipContent() {
    var _this;
    ...
    _this.setRef = function (e) {
      return _this.smartTipContent = e;
    };

    return _this;
  }

  var _proto = SmartTipContent.prototype;
  ...
  _proto.calcTrueWidth = function calcTrueWidth() {
    var smartTipContent = this.smartTipContent;
    var computedStyle = window.getComputedStyle(smartTipContent);
    var matrixVal = computedStyle.getPropertyValue('transform') || computedStyle.getPropertyValue('-moz-transform') || computedStyle.getPropertyValue('-webkit-transform') || computedStyle.getPropertyValue('-ms-transform') || computedStyle.getPropertyValue('-o-transform');
    matrixVal = matrixVal && matrixVal !== 'none' ? matrixVal.split('(')[1].split(')')[0].split(',').map(_parseFloat$2) : null;
    var widthScale = matrixVal ? matrixVal[0] : 1;
    smartTipContent.style.width = ''; // Reset width to re-calcuate

    smartTipContent.style.position = 'fixed';
    smartTipContent.style.transform = 'scale(1)'; // Calculate full width as per position: fixed

    var renderWidthWithFixed = smartTipContent.getBoundingClientRect().width;
    smartTipContent.style.width = Math.ceil(renderWidthWithFixed / widthScale) + 'px'; // Reset to original styles
  ...
  _proto.shiftPosition = function shiftPosition() {
    ...
    var _parentEl$getBounding = parentEl.getBoundingClientRect(),
        x = _parentEl$getBounding.x,
        y = _parentEl$getBounding.y,
        triggerWidth = _parentEl$getBounding.width,
        _smartTipContent$getB = smartTipContent.getBoundingClientRect(),
        contentWidth = _smartTipContent$getB.width;

    smartTipContent.style.top = y + 'px';
    smartTipContent.style.left = x - contentWidth / 2 + triggerWidth / 2 + 'px';
    var frameRect = document.body.getBoundingClientRect();
    var newBoundingRect = smartTipContent.getBoundingClientRect();
    var netPosToolTip = newBoundingRect.x + newBoundingRect.width;
    var netPosFrame = frameRect.x + frameRect.width;

    if (netPosToolTip > netPosFrame) {
      // Right side of tooltip exceeding right side of frame
      // this.set({toolTipPosShift: 'left'});
      smartTipContent.style.left = x - contentWidth + triggerWidth + 'px';
    } else if (newBoundingRect.x < frameRect.x) {
      // Left side of tooltip is falling behind left side of frame
  ...
  _proto.render = function render() {
    ...
    return React.createElement("span", {
      ref: this.setRef,
      className: classList('SmartTipContent', prefixToClasses('SmartTipContent--', className), uiClass)
    }, children, React.createElement("span", {
      className: "arrow"
    }));
  };

  return SmartTipContent;
}(React.PureComponent);
...
function (_React$Component) {
  ...
  _proto.render = function render() {
    var _this$props = this.props,
        className = _this$props.className,
        uiClass = _this$props.uiClass,
        uiClassContent = _this$props.uiClassContent,
        children = _this$props.children,
        tooltipContent = _this$props.tooltipContent;
    return React.createElement("div", {
      ref: this.setRef,
      className: classList('Tooltip', prefixToClasses('Tooltip--', className), uiClass)
    }, React.createElement("span", {
      className: "Tooltip-trigger",
      onMouseEnter: this.onMouseEnter,
      onMouseLeave: this.onMouseLeave
    }, children), React.createElement(SmartTipContent, {
...
function (_React$Component) {
  ...
  _proto._showPopover = function _showPopover(e) {
    ...
    if (!this.props.triggerOnHover) {
      ...
      var delay = typeof this.props.delay !== 'undefined' ? this.props.delay : 250; // Delay = 250ms (default)
  ...
  _proto.render = function render() {
    ...
    }, this.state.show && React.createElement(SmartTipContent, {
      parentEl: this.popover,
      uiClass: uiClassContent,
      className: "Popover"
    }, popoverContent(this.hidePopover)), React.createElement("span", {
...
/*#__PURE__*/
function (_React$PureComponent) {
  inheritsLoose(Clipboard, _React$PureComponent);
  ...
  function Clipboard(props) {
    ...
    _this.onCopyEnd = _this._onCopyEnd.bind(assertThisInitialized(_this));
    return _this;
  }
  ...
  _proto._copyToClipboard = function _copyToClipboard() {
    ...
    setTimeout(function (_) {
      return _this2.onCopyEnd();
    }, 1500);
    this.props.onCopy && this.props.onCopy();
  };

  _proto._onCopyEnd = function _onCopyEnd() {
    this.setState({
      isCopied: false
    });
  };
  ...
  _proto.render = function render() {
    var _this$props = this.props,
        ...
        hideTextarea = _this$props.hideTextarea,
        children = _this$props.children;
    ...
    return React.createElement("span", {
      className: classList('Clipboard', prefixToClasses('Clipboard--', className), isCopied && 'Clipboard--copied', hideTextarea && 'Clipboard--hideTextarea')
      ...
      onClick: isCopied ? undefined : this.copyToClipboard
...
function Tag(_ref) {
  var children = _ref.children,
      ...
      uiClass = _ref.uiClass;
  return React.createElement("div", {
    className: classList('Tag', prefixToClasses('Tag--', className), uiClass)
  }, children);
}
...
function (_React$PureComponent) {
  ...
  _proto2.render = function render() {
    var _this$props = this.props,
        ...
        children = _this$props.children;
    return React.createElement("div", {
      className: classList(stackItemType, prefixToClasses(stackItemType + "--", className), showCross && stackItemType + "--hasCross", uiClass)
    }, React.createElement("span", {
...
function openToast(_ref) {
  var className = _ref.className,
      ...
      enableAutoRemove = _ref.enableAutoRemove,
...
function openNotification(_ref) {
  var className = _ref.className,
      uiClass = _ref.uiClass,
      showCross = _ref.showCross,
      duration = _ref.duration,
...
function (_React$PureComponent) {
  ...
  _proto.onShowBD = function onShowBD() {
  ...
  _proto.onHideBD = function onHideBD() {
...
function openPopup(_ref) {
  var className = _ref.className,
      ...
      content = _ref.content,
      showCross = _ref.showCross,
      enableEscPress = _ref.enableEscPress,
      enableOutsideClick = _ref.enableOutsideClick;
...
function (_React$PureComponent) {
  ...
  _proto.render = function render() {
    var _this$props = this.props,
        ...
        affirmButtonClass = _this$props.affirmButtonClass,
        cancelButtonClass = _this$props.cancelButtonClass;
...
function openConfirmPopup(_ref) {
  var className = _ref.className,
      ...
      affirmButtonClass = _ref.affirmButtonClass,
      cancelButtonClass = _ref.cancelButtonClass,
      restProps = objectWithoutPropertiesLoose(_ref, ["className", "uiClass", "title", "description", "affirmLabel", "cancelLabel", "onAffirm", "onCancel", "affirmButtonClass", "cancelButtonClass"]);
...
var Spinner = function Spinner(_ref) {
  var _ref$show = _ref.show,
      ...
      uiClass = _ref.uiClass;
  return React.createElement("span", {
    className: classList('Spinner', show && 'Spinner--show', className && prefixToClasses('Spinner--', className), uiClass)
  });
};
...
function (_React$PureComponent) {
  ...
  _proto.render = function render() {
    var _this$props = this.props,
        ...
        uiClass = _this$props.uiClass;
    return React.createElement("div", {
      className: classList('Card', prefixToClasses('Card--', className), uiClass)
    }, children);
  };
...
var Banner = function Banner(_ref) {
  var children = _ref.children,
      ...
      uiClass = _ref.uiClass;
  return React.createElement("div", {
    className: classList('Banner', prefixToClasses('Banner--', className), uiClass)
  }, children);
};
...
export { AsyncButton, AutoRemoveLayer, BackDrop, Banner, Button, Card, Checkbox, CheckboxElement, Clipboard, Dropdown, DropdownItem, ErrorBoundary, EscPressLayer, Form, GhostLoader, HelpText, Input, InputElement, NotificationsContainer, OutsideClickLayer, Popover, PopupsContainer, RadioGroup, RadioGroupElement, RipplePointer, Select, SelectElement, SmartTipContent, SmoothScrollLink, Spinner, Tag, TagsList, Textarea, TextareaElement, ToastsContainer, Tooltip, openConfirmPopup, openNotification, openPopup, openToast };
